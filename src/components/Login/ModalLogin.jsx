...
function ModalLogin({ setModalLoginOpen }) {
  ...
  function handleLogin() {
    ...
    signIn({username: username, email: email, senha: senha, manterLogin: manterLogin});
  }
      ...
      <div className="modalBackground">
        <div className="modalContainer">
          ...
          <div className="loginBody">
              <label id="labelcampo" htmlFor="campo">Email/User |</label>
              <input onFocus={() => {
                ...
                type="text" className="campo" id="campo"/>
              ...
              <input onFocus={() => {
                ...
                type="password" className="senha" id="senha"/>
          </div>
          <div className="toggles">
            <div className="divtoggle">
              <h3>Mostrar Senha</h3>
              <input className="toggle" id="toggle" type="checkbox" onClick={mostrarSenha}></input>
              <label className="togglelabel" htmlFor="toggle"></label>
            </div>
            <div className="divtoggle">
              <h3>Manter Login</h3>
              <input className="toggle1" id="toggle1" type="checkbox" onClick={switchManterLogin}></input>
